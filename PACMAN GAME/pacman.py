...
pacman1=pygame.image.load('pacman_2_2018042.png')
pacman2=pygame.image.load('pacman_21_2018042.png')
pacman3=pygame.image.load('pacman_22_2018042.png')
pacman4=pygame.image.load('pacman_23_2018042.png')
heart=pygame.image.load('package_favourite_2018042.png')
ghost=pygame.image.load('ghost_2018042.png')
...
layout_1 = loadtxt('level1_2018042.txt', dtype=str)
layout2 = loadtxt('level2_2018042.txt', dtype=str)
if temp==1 or temp==0:
	layout1=layout_1
elif temp==10:
	layout1=layout2
...
# Main game loop 
  ...
  #In the board, '.' denote the empty space, 'w' are the walls, 'c' are the coins
	...
	if no_==0 and temp==10:
		...
		time.sleep(2)
		message('MADE BY: ISHAN KAPUR 2018042',lt,PACMAN_COLOR,pixels_from_points((10,10)))
		time.sleep(2)
		exit()
